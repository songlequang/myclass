...
class wplms_announcement extends WP_Widget {
    ...
    $this->WP_Widget( 'wplms_announcement', __(' DASHBOARD : Instructor announcement Widget', 'wplms-dashboard'), $widget_ops, $control_ops );
    ...
    function send_announcements(){
      ...
      foreach($course_list as $list){
        if(is_numeric($list)){
          ...
          do_action('wplms_dashboard_course_announcement',$list,$student_type,$announcement);
        }
      }
