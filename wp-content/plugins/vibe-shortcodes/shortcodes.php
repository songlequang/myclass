...
if (!function_exists('vibe_question')) {
	function vibe_question( $atts, $content = null ) {
    		...
    		$return .='<div class="question_content">'.do_shortcode($question->post_content);
    		...
    		switch($type){
		      ...
		      if(isset($explaination) && strlen($explaination)>2){
		      	$return .= '<li><a href="#question_explaination'.$id.'" class="open_popup_link">'.__('Explaination','vibe').'</a></li>';
