...
class bp_course_activity{
	...
	function course_subscribed($course_id,$user_id,$group_id){
		bp_course_record_activity(array(
	...
	function course_unsubscribe($course_id,$user_id,$group_id){
		bp_course_record_activity(array(
	...
	function submit_assignment($assignment_id,$user_id){
		...
		$activity_id=bp_course_record_activity(array(
          ...
          'content' => sprintf(__('Student % submitted the assignment %s','vibe'),bp_core_get_userlink($user_id),get_the_title($assignment_id)),
