...
function add_vibe_metaboxes(){
	...
	$testimonial_metabox = apply_filters('wplms_testimonial_metabox',$testimonial_metabox);
...
if(!function_exists('add_vibe_editor')){
	function add_vibe_editor(){
	    add_meta_box( 'vibe-editor', __( 'Page Builder', 'vibe-customtypes' ), 'vibe_layout_editor', 'page', 'normal', 'high' );
	}
}
