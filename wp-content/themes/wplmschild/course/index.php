...
<!--            <div class="col-md-3 col-sm-4">-->
                <?php
////            		do_action('wplms_be_instructor_button'); Load button Create Course
//				?>
<!--            </div>-->
        </div>
    </div>
...
<section id="content">
	...
	<?php do_action( 'bp_before_directory_course_page' ); ?>
		...
		<div class="row">
			<div class="content_mycourse col-md-9 col-sm-8">
				<form action="" method="post" id="course-directory-form" class="dir-form">
                        ...
                        <div class="title_tab">
                            <ul>
                                ...
                                <?php if ( is_user_logged_in() ) : ?>
                                    ...
                                    <li class="selected" id="course-personal"><a href="<?php echo trailingslashit( bp_loggedin_user_domain() . bp_get_course_slug() . BP_COURSE_SLUG ); ?>"><?php printf( __( 'My Courses <span>%s</span>', 'vibe' ), bp_course_get_total_course_count_for_user( bp_loggedin_user_id() ) ); ?></a></li>
					...
					<div class="item-list-tabs" id="subnav" role="navigation">
						<ul>
							...
							<li class="switch_view"><a id="list_view"><i class="icon-list-1"></i></a><a id="grid_view" class="active"><i class="icon-grid"></i></a>
							</li>
