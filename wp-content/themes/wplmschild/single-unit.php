...
//                    echo '<input id="course_id" type="hidden" value="'.$_GET['id'].'"><a href="'.get_permalink($_GET['id']).'?action=curriculum" class="course_button button full">'.__('Back to Course','vibe').'</a>';
                    echo '<input id="course_id" type="hidden" value="'.$_GET['id'].'"><a href="'.get_permalink($_GET['id']).'" class="course_button button full">'.__('Back to Course','vibe').'</a>';
                  }
                }else{
                  global $wpdb;
                  $uid=get_the_ID();
                  ...
                  if(is_numeric($course_id) && get_post_type($course_id) == 'course'){
                    ...
                    echo '<input id="course_id" type="hidden" value="'.$course_id.'"><a href="'.get_permalink($course_id).'?action=curriculum" class="course_button button full">'.__('Back to Course','vibe').'</a>';
                  }else{
                    vibe_breadcrumbs();
                  }
                }
