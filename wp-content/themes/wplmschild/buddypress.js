...
jQuery(document).ready( function() {
	jQuery('.footerwidget div#members-list-options a').on('click',
		function() {
			var link = this;
			jQuery(link).addClass('loading');

			jQuery('.footerwidget div#members-list-options a').removeClass('selected');
...
function footermember_wiget_response(response) {
	...
	if ( response[0] !== '-1' ) {
		jQuery('.footerwidget ul#members-list').fadeOut(200,
			function() {
				jQuery('.footerwidget ul#members-list').html(response[1]);
				jQuery('.footerwidget ul#members-list').fadeIn(200);
			}
		);
		...
		jQuery('.footerwidget ul#members-list').fadeOut(200,
			function() {
				...
				jQuery('.footerwidget ul#members-list').html(message);
				jQuery('.footerwidget ul#members-list').fadeIn(200);
			}
		);
	}
...
jQuery(document).ready( function() {
	jQuery('.footerwidget div#groups-list-options a').on('click',
		function() {
			var link = this;
			jQuery(link).addClass('loading');

			jQuery('.footerwidget div#groups-list-options a').removeClass('selected');
			jQuery(this).addClass('selected');
...
function footergroups_wiget_response(response) {
	...
	if ( response[0] !== '-1' ) {
		jQuery('.footerwidget ul#groups-list').fadeOut(200,
			function() {
				jQuery('.footerwidget ul#groups-list').html(response[1]);
				jQuery('.footerwidget ul#groups-list').fadeIn(200);
			}
		);
		...
		jQuery('.footerwidget ul#groups-list').fadeOut(200,
			function() {
				var message = '<p>' + response[1] + '</p>';
				jQuery('.footerwidget ul#groups-list').html(message);
				jQuery('.footerwidget ul#groups-list').fadeIn(200);
			}
		);
	}
