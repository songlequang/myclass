...
<section id="content">
    ...
    <div class="hiddenmenu">
        <div class="container">
            <div class="nav-hidden-menu col-md-8 col-sm-8">
                <ul>
                    <li class="tab-btn btn-description activehiddenmenu">
                        <a href="#description"><?php _e('Mô tả khóa học','vibe') ?></a>
                    </li>
                    <li class="tab-btn btn-curriculum">
                        <a href="#curriculum"><?php _e('Đề cương','vibe') ?></a>
                    </li>
                    <li class="tab-btn btn-instrutor">
                        <a href="#instructor"><?php _e('Giảng viên','vibe') ?></a>
                    </li>
                    <li class="tab-btn btn-review">
                        <a href="#review"><?php _e('Đánh giá','vibe') ?></a>
                    </li>
                </ul>
            </div>

            <div class="col-md-4 col-sm-4">
                <div class="row button-hoc">
                    <div class="btn-hoc col-md-6 col-sm-6">
                        <?php nuthanhtoan(); ?>
                    </div>

                    <div class="gia-hidenmenu col-md-6 col-sm-6">
                ...
                <div id="item-body">
                    ...
                    if(isset($_GET['action']) && $_GET['action']):
                        ...
                        switch($_GET['action']){
                            ...
                            default:
                                $action = $_GET['action'];
                                $template = apply_filters('wplms_course_locate_template',array( 'course/single/front.php' ),$action);
